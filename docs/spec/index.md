...
[Language Core v0.5](language-core-v0.5.md). It extends
[Language Core v0.4](language-core-v0.4.md) with nominal tagged unions,
qualified construction, guarded recursive data, and exhaustive matching. Nexa
remains a TypeScript-shaped language with its own native semantics, not a
...
Language Core v0.5 is normative and delivered. The active implementation
milestone is v0.6, which adds explicit multi-file modules under the
...
nominal records, and v0.5 is the current tagged-union core.
